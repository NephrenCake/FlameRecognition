...
from Pioneer.utils.utils import read_split_data, train_one_epoch, evaluate
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str, default="./source/fire")
    parser.add_argument('--weights', type=str, default='./weights_pre/efficientnetb0.pth', help='initial weights path')
